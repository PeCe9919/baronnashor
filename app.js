...
bot.on('message', message => {
    ...
    if (msg == prefix + 'playgame') {
        ...
        //DEBUG
        message.guild.channels.get('448048716276957184').send({embed: {
            title: "Command use",
...
bot.on("ready", async () => {
    ...
    bot.user.setActivity(`l'Avenir`, {type: "WATCHING"});
});
...
bot.login('NDU0OTA1OTkzMjk4NzA2NDMy.Df0Szg.bJ4CVe-xE_YRyyFDidhrqIZx6ps')
//old NDM4ODM3Nzc0Mjg4NjgzMDEw.DcKbCg.3dq25LrW3modQIlnaR4a9i1GzX0